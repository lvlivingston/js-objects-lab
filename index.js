...
album3.albumDetails.formats = [album2.albumDetails.formats['0']];
console.log('Exercise 3:', album3.albumDetails.formats); 
  
  
  // Exercise 4:  Update the released property of album3 from a string into a Date object using that string
let formattedDate = new Date([album3.albumDetails.released]);
const month = formattedDate.getMonth() + 1; 
const day = formattedDate.getDate();
const year = formattedDate.getFullYear();
const formattedDateString = [`${month}/${day}/${year}`];
console.log('Exercise 4:', formattedDateString);
...
/* *****Why am I getting extra [] in the answer??***** */
  
  
  // Exercise 9:  Using the talkingHeadsAlbums array, assign album7's released property to album6's released property
talkingHeadsAlbums[5] = talkingHeadsAlbums[6].albumDetails.released;

let formattedDate2 = new Date([talkingHeadsAlbums[5]]);
const month2 = formattedDate2.getMonth() + 1; 
const day2 = formattedDate2.getDate();
const year2 = formattedDate2.getFullYear();
const formattedDateString2 = [`${month2}/${day2}/${year2}`];
console.log('Exercise 9:', formattedDateString2);
